...
| | | |
|---|---|---|
| Bot | **running** | 336 cycles |
| Last cycle | **20:14** | 2026-08-20 |
| Leads | **26152** | 26152 checked |
| Call list | **4626** | no email found |
| Daily cap | **off** | 47 sent today |

## Needs a decision

- **4626 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
