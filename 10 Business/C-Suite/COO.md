...
| | | |
|---|---|---|
| Bot | **running** | 302 cycles |
| Last cycle | **22:14** | 2026-08-19 |
| Leads | **25474** | 25474 checked |
| Call list | **4392** | no email found |
| Daily cap | **off** | 49 sent today |

## Needs a decision

- **4392 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
