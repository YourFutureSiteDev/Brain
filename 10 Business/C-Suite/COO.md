...
| | | |
|---|---|---|
| Bot | **running** | 407 cycles |
| Last cycle | **14:51** | 2026-08-22 |
| Leads | **28082** | 28082 checked |
| Call list | **5174** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **5174 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
