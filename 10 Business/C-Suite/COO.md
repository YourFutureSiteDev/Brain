...
| | | |
|---|---|---|
| Bot | **running** | 426 cycles |
| Last cycle | **01:05** | 2026-08-23 |
| Leads | **28682** | 28682 checked |
| Call list | **5347** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **5347 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
