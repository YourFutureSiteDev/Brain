...
| | | |
|---|---|---|
| Bot | **running** | 333 cycles |
| Last cycle | **18:38** | 2026-08-20 |
| Leads | **26080** | 26080 checked |
| Call list | **4578** | no email found |
| Daily cap | **off** | 47 sent today |

## Needs a decision

- **4578 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
