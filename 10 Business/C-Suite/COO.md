...
| | | |
|---|---|---|
| Bot | **running** | 343 cycles |
| Last cycle | **00:13** | 2026-08-21 |
| Leads | **26646** | 26646 checked |
| Call list | **4779** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4779 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
