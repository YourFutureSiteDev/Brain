...
| | | |
|---|---|---|
| Bot | **running** | 339 cycles |
| Last cycle | **21:53** | 2026-08-20 |
| Leads | **26309** | 26309 checked |
| Call list | **4678** | no email found |
| Daily cap | **off** | 47 sent today |

## Needs a decision

- **4678 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
