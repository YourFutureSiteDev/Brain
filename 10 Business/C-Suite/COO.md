...
| | | |
|---|---|---|
| Bot | **running** | 406 cycles |
| Last cycle | **14:19** | 2026-08-22 |
| Leads | **28073** | 28073 checked |
| Call list | **5166** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **5166 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
