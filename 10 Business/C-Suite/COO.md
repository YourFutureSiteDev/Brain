...
| | | |
|---|---|---|
| Bot | **running** | 309 cycles |
| Last cycle | **01:39** | 2026-08-20 |
| Leads | **25486** | 25486 checked |
| Call list | **4401** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4401 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
