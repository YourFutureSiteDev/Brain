...
| | | |
|---|---|---|
| Bot | **running** | 349 cycles |
| Last cycle | **03:34** | 2026-08-21 |
| Leads | **26848** | 26848 checked |
| Call list | **4877** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4877 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
