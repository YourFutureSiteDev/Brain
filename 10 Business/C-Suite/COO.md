...
| | | |
|---|---|---|
| Bot | **running** | 385 cycles |
| Last cycle | **03:01** | 2026-08-22 |
| Leads | **27576** | 27576 checked |
| Call list | **5059** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **5059 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
