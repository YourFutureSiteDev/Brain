...
| | | |
|---|---|---|
| Bot | **running** | 293 cycles |
| Last cycle | **17:28** | 2026-08-19 |
| Leads | **25395** | 25395 checked |
| Call list | **4325** | no email found |
| Daily cap | **off** | 50 sent today |

## Needs a decision

- **4325 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
