...
| | | |
|---|---|---|
| Bot | **running** | 348 cycles |
| Last cycle | **02:57** | 2026-08-21 |
| Leads | **26819** | 26819 checked |
| Call list | **4863** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4863 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
