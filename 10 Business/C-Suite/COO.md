...
| | | |
|---|---|---|
| Bot | **running** | 287 cycles |
| Last cycle | **09:53** | 2026-08-19 |
| Leads | **22631** | 22631 checked |
| Call list | **3055** | no email found |
| Daily cap | **off** | 1 sent today |

## Needs a decision

- **3055 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
