...
| | | |
|---|---|---|
| Bot | **running** | 335 cycles |
| Last cycle | **19:42** | 2026-08-20 |
| Leads | **26114** | 26114 checked |
| Call list | **4609** | no email found |
| Daily cap | **off** | 47 sent today |

## Needs a decision

- **4609 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
