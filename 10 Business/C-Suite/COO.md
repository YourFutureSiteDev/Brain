...
| | | |
|---|---|---|
| Bot | **running** | 306 cycles |
| Last cycle | **00:04** | 2026-08-20 |
| Leads | **25480** | 25480 checked |
| Call list | **4398** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4398 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
