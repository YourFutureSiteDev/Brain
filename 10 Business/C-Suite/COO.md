...
| | | |
|---|---|---|
| Bot | **running** | 307 cycles |
| Last cycle | **00:36** | 2026-08-20 |
| Leads | **25483** | 25483 checked |
| Call list | **4399** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4399 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
