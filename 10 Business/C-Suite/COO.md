...
| | | |
|---|---|---|
| Bot | **running** | 366 cycles |
| Last cycle | **16:43** | 2026-08-21 |
| Leads | **27262** | 27262 checked |
| Call list | **5017** | no email found |
| Daily cap | **off** | 49 sent today |

## Needs a decision

- **5017 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
