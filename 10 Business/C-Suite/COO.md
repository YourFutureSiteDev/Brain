...
| | | |
|---|---|---|
| Bot | **running** | 288 cycles |
| Last cycle | **10:25** | 2026-08-19 |
| Leads | **22650** | 22650 checked |
| Call list | **3056** | no email found |
| Daily cap | **off** | 1 sent today |

## Needs a decision

- **3056 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
