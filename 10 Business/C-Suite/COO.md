...
| | | |
|---|---|---|
| Bot | **running** | 342 cycles |
| Last cycle | **23:33** | 2026-08-20 |
| Leads | **26627** | 26627 checked |
| Call list | **4762** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4762 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
