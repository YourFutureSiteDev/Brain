...
| | | |
|---|---|---|
| Bot | **running** | 382 cycles |
| Last cycle | **01:26** | 2026-08-22 |
| Leads | **27568** | 27568 checked |
| Call list | **5057** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **5057 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
