...
| | | |
|---|---|---|
| Bot | **running** | 417 cycles |
| Last cycle | **20:15** | 2026-08-22 |
| Leads | **28346** | 28346 checked |
| Call list | **5251** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **5251 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
