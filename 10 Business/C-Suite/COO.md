...
| | | |
|---|---|---|
| Bot | **running** | 334 cycles |
| Last cycle | **19:10** | 2026-08-20 |
| Leads | **26095** | 26095 checked |
| Call list | **4593** | no email found |
| Daily cap | **off** | 47 sent today |

## Needs a decision

- **4593 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
