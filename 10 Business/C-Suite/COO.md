...
| | | |
|---|---|---|
| Bot | **running** | 316 cycles |
| Last cycle | **05:20** | 2026-08-20 |
| Leads | **25511** | 25511 checked |
| Call list | **4422** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4422 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
