...
| | | |
|---|---|---|
| Bot | **running** | 347 cycles |
| Last cycle | **02:22** | 2026-08-21 |
| Leads | **26791** | 26791 checked |
| Call list | **4849** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4849 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
