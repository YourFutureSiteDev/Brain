...
| | | |
|---|---|---|
| Bot | **running** | 305 cycles |
| Last cycle | **23:32** | 2026-08-19 |
| Leads | **25478** | 25478 checked |
| Call list | **4396** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **4396 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
...
Back to [[C-Suite]]. Written by the Your Future Site console on the VPS, 2026-08-20T00:04:29. Edit it here and the next cycle overwrites you, so put your own thinking in a note of your own and link it.
