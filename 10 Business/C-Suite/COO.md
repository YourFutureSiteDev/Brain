...
| | | |
|---|---|---|
| Bot | **running** | 420 cycles |
| Last cycle | **21:52** | 2026-08-22 |
| Leads | **28522** | 28522 checked |
| Call list | **5293** | no email found |
| Daily cap | **off** | 0 sent today |

## Needs a decision

- **5293 leads have a phone but no email.** The bot cannot reach these. They are the call list, and they are often the best prospects precisely because their web presence is worst.
