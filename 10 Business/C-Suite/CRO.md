...
> 50 in the call queue; chasing at 14 days

| | | |
|---|---|---|
| Emailed | **15** | businesses |
| Replied | **0** | 0.0% |
...
- **No replies from any email yet.** Either the message is not landing or the leads are wrong. Campaigns shows which niche is being hit.
