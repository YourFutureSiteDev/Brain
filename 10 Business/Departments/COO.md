...
## Every care client sold subtracts from next month's build hours

*tried, revised 0 times, learned 2026-08-18 from brief.*

Track active care clients against the 30 client / 12 hour trigger every time a care plan sells, and flag it the moment either line is crossed, not at month end.

> Evidence: Section 5: the care book eats the business, wall at 30 to 35 active care clients around month 5 or 6.
...
During any blackout, keep outreach running and just change its call to action to book future slots. Pause calls, big builds and the change queue instead.

> Evidence: Section 7: 'What must never be paused: the bot', restarting cold outreach costs weeks.
